...
public class DialogBuilder extends AppCompatActivity {
    ...
    //Auflisten aller ScanItems und neues BestandItem daraus erstellen
    ...
    //mit vorgegeben Barcode (aus Scanner) ein ScanItem erstellen
    ...
    //aus vorgegebenen ScanItem das ScanItem bearbeiten (außer Barcode)
    ...
    //Aus vorgegebenen ScanItem (aus listAllScanItems oder durch erstes Einscannen) ein neues BestandItem erstellen
    private void createNewBestandItem(final ScanItem scanItem) {
    ...
    //aus vorgegebenen BestandItem ein BestandItem bearbeiten
    ...
    //für BestandItems Notifications erstellen
    private void createNotification(BestandItem bestandItem) {
    ...
    //für BestandItems Notifications löschen
    private void deleteNotification(BestandItem bestandItem) {
        NotificationPublisher notificationPublisher = new NotificationPublisher();
